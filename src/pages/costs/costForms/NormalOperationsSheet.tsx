...
export const NormalOperationsSheet = () => {
    ...
    return (
        ...
        <Box display="flex" flexDirection="row" justifyContent="space-between">
          <Typography fontWeight="bold" bgcolor="blue" paddingX={2} variant="h5">
            Operações Normais
          </Typography>
        ...
        <Box display="flex" flexDirection="row" justifyContent="end">
          <Typography paddingX={5} bgcolor="blue" variant="h6">
            Total de Operações
          </Typography>
          <Box display="flex" right={0} border={1} borderColor="blue">
